...
const copy: Record<Locale, Copy> = {
  ...
  en: {
    ...
    app: { searchPlaceholder: 'Search area or address', searchLabel: 'Search', fuel: 'Fuel', province: 'Province', municipality: 'Municipality', anyProvince: 'All', anyMunicipality: 'All', radius: 'Radius', results: 'Results', summaryLabel: 'Price summary', navLabel: 'Fuel app sections', map: 'Map', centerMap: 'Center', viewList: 'View list', chart: 'Fuel 95 history', utilities: 'Tools', cheapest: 'Cheapest', average: 'Average', expensive: 'Most expensive', selectedFuel: 'Fuel 95', radar: 'Price radar', stationsAnalyzed: 'stations analyzed', bestNearYou: 'Best price near you', sort: 'Sort', price: 'Price', distance: 'Distance', filters: 'Quick filters', all: 'All', underPrice: '< €1.65', openNow: 'Nearby', historyShort: 'History', saving: '50L saving', loading: 'Loading…', empty: 'No data.', detail: 'Detail', viewZone: 'View area', stationSaved: 'Station saved.', placeSaved: 'Area saved.', location: 'Finding location…', locationShort: 'Near me', locationError: 'Could not get location.', deviceLocationShort: 'My area', ipLocation: 'Using approximate IP location…', ipLocationShort: 'Your area', demoUpdate: 'Today 08:45', demoNotice: 'Visual demo without API key', liters: 'Liters', priceDifference: 'Difference €/l' },
  },
};
